...
FEATURES = [
    ...
    dict(id="topic", name="주제 이탈 감지", icon="🧭", type="topic",
         ...
         utts=[
             ...
             u(5.2, "지호", "근데 어제 본 영상에서는 AI가 발표자료를 진짜 화려하게 만들더라.", off=True),
             u(10.8, "하준", "맞아, 템플릿도 많고 배경도 자동으로 바꿔 주던데.", off=True),
             u(15.5, "지호", "어떤 건 목소리까지 만들어 주잖아. 거의 영상 앱 같아.", off=True),
             u(20.5, "윤서", "그런 기능 신기하긴 하다. 나도 해 보고 싶어.", off=True),
             u(25.3, "하준", "우리 반에도 써 본 애 있을걸?", off=True),
             u(33.0, "수아", "그래, 다시 조건 이야기로 돌아가자."),
             u(36.8, "지호", "미안 미안. 표시 조건 다음으로 넘어가자."),
         ]),
    ...
    dict(id="timer", name="시간 관리", icon="⏱️", type="timer",
         ...
         timerStart=30,
         utts=[
             u(0.5, "수아", "비판검토 시간이 삼십 초 남았어. 슬슬 마무리하자."),
             u(6.0, "하준", "잠깐, 아직 반론 검토 못 한 게 있는데."),
             u(11.0, "지호", "표시 조건의 단점도 봐야 하는데…"),
             u(16.5, "윤서", "이것도 얘기해야 하고, 저것도 남았고…"),
             u(22.5, "하준", "시간이 부족하네. 어떡하지?"),
             u(33.5, "수아", "좋아, 나온 것까지 정리하고 넘어가자."),
             u(37.5, "지호", "찬성!"),
         ]),
